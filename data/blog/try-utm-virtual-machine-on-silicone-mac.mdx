...
<Image src={import('src/assets/images/insider-preview_1.jpg')} alt="Insider Preview view with the Editions menu open"/>
...
<Image src={import('src/assets/images/import-vdhx_2.jpg')} alt="A view of the Import VHDX image dialog"/>
...
<Image src={import('src/assets/images/mem-cores-setup_3.jpg')} alt="Insider Preview view with the Editions menu open"/>
...
<Image src={import('src/assets/images/spice-installer_6.jpg')} alt="Install SPICE tools from Windows Explorer drives"/>
